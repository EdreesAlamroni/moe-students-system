...
return [
    ...
    */
    ...
    'custom' => [
        'student_transfer' => [
            ...
            'student_ids_array' => 'صيغة قائمة الطلبة غير صحيحة. يرجى إعادة البحث وتحديد الطلبة من النتائج.',
            'student_ids_min' => 'يجب تحديد طالب واحد على الأقل لإضافته إلى المدرسة.',
            'student_id_required' => 'معرّف الطالب مطلوب. يرجى إعادة البحث وتحديد الطلبة من النتائج.',
            'student_id_integer' => 'معرّف الطالب غير صالح. يرجى إعادة البحث وتحديد الطلبة من النتائج.',
            'student_id_distinct' => 'تم تحديد بعض الطلبة أكثر من مرة. يرجى إزالة التكرار والمحاولة مرة أخرى.',
            'student_id_not_found' => 'أحد الطلبة المحددين غير موجود في النظام. يرجى إعادة البحث وتحديث القائمة.',
            'already_in_school' => 'تعذّر إضافة الطالب/الطالبة :name لأنه مسجّل بالفعل في مدرسة. يمكن إضافة الطلبة المُنتقلين فقط الذين لا ينتمون إلى أي مدرسة حالياً.',
        ...
        'education_monitor_student_transfer' => [
            ...
            'already_in_monitor' => 'تعذّر إضافة الطالب/الطالبة :name لأنه مسجّل بالفعل في مُراقبة تعليمية. يمكن إضافة الطلبة المُنتقلين فقط الذين لا ينتمون إلى أي مُراقبة حالياً.',
        ],
        'class_schedule' => [
        ...
        'grade_levels' => [
            ...
            'must_be_unique_across_periods' => 'يجب ألا تتكرر الصفوف الدراسية بين الفترتين الصباحية والمسائية عندما تكون المدرسة واحدة.',
            'must_be_available_for_school' => 'يجب أن تكون الصفوف الدراسية المحددة من الصفوف المتاحة للإضافة، بحيث تنتمي إلى المراحل الدراسية للمدرسة ولم تُضف مسبقاً لأي من فترتي الدراسة.',
            'must_have_sibling_period' => 'لا يمكن نقل الصفوف الدراسية إلا عندما يكون للمدرسة فترة دراسية أخرى (صباحية/مسائية).',
            'must_belong_to_current_period' => 'يجب أن تكون الصفوف الدراسية المحددة مُضافة إلى الفترة الدراسية الحالية في السنة الدراسية الحالية.',
            'must_not_exist_in_destination_period' => 'لا يمكن نقل صفوف دراسية موجودة مسبقاً في الفترة الدراسية الأخرى.',
    ...
    */
    ...
    'attributes' => [
        ...
        'education_monitor_ids' => 'المُراقبات',
        ...
        'type' => 'نوع المدرسة',
        'academic_period' => 'الفترة الدراسية',
        'is_same_school' => 'هل الفترتان لنفس المدرسة',
        'educational_company_name' => 'اسم الشركة التعليمية',
        'branch_type' => 'فرع المدرسة',
        'building_type' => 'نوع المبنى',
        'name_morning' => 'اسم المدرسة (الفترة الصباحية)',
        'name_evening' => 'اسم المدرسة (الفترة المسائية)',
        'students_gender' => 'جنس الطلبة الدارسين بالمدرسة',
        'students_gender_morning' => 'جنس الطلبة الدارسين بالمدرسة (الفترة الصباحية)',
        'students_gender_evening' => 'جنس الطلبة الدارسين بالمدرسة (الفترة المسائية)',
