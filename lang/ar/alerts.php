...
return [
    ...
    'messages' => [
        ...
        'classroom-distribution-capacity-shortage' => 'تجاوز عدد الطلبة السعة المتاحة في الفصول المحددة. تم توزيع :assigned طالب/طالبة، وتجاوز السعة لـ :overflow طالب/طالبة.',
        'classroom-distribution-finalized' => 'تم إتمام توزيع الطلبة على الفصول لهذه السنة الدراسية. لا يمكن تعديل التوزيع بعد الآن.',
        'classroom-distribution-already-finalized' => 'تم إتمام توزيع الطلبة على الفصول مسبقاً لهذه السنة الدراسية.',
        'classroom-distribution-invalid-students' => 'بعض الطلبة المحددين غير متاحين للتعيين (تأكد أنهم بلا فصل في هذا الصف).',
        ...
        'classroom-students-not-found' => 'لا يوجد طلبة في هذا الفصل الدراسي.',
        ...
        'school-students-gender-updated' => 'تم تحديد جنس الطلبة الدارسين بالمدرسة بنجاح.',
    ],
];
