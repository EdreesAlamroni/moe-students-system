...
import { index, print } from "@/routes/administration/reports/education-services-offices";
...
export default function Index({ offices, monitors, filter, canAny, can }: PageProps) {
