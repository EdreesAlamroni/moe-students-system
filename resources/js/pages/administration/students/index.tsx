...
import { Building2Icon, ListIcon, LoaderIcon, RefreshCcwIcon, SearchIcon } from "lucide-react";
...
export default function Index({
    ...
    const handleMonitorChange = (value: string) => {
        setPendingOrganization({ monitorId: value });
                    ...
                    <Card>
                        <CardContent>
                            <EmptyState
                                ...
                                description={
                                    activeMonitorId
                                        ? "بعد اختيار المدرسة، ستظهر فلاتر البحث وقائمة الطلاب المسجّلين فيها."
                                        : "اختر المُراقبة ثم المدرسة لعرض قائمة الطلاب وتطبيق فلاتر البحث."
                                }
                            />
                        </CardContent>
                    </Card>
                    ...
                    <section>
                        <Card>
                            ...
                            {studentData.length > 0 ? (
                                ...
                                <CardContent>
                                    <EmptyState hasFilter={hasStudentFilter} />
                                </CardContent>
                            )}
