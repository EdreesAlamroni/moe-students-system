...
import { show as showPsychosocialCard } from "@/routes/administration/students/psychosocial-card";
import { show as showAcademicRecord } from "@/routes/administration/students/academic-record";
                        ...
                        <CardContent className="flex flex-col gap-6">
                            <DetailFields columns={2}>
                                ...
                                <DetailField>
                                    ...
                                    <DetailValue value={student.school_period?.name} />
                                </DetailField>
