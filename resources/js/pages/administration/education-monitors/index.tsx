...
import { create, index, show } from "@/routes/administration/education-monitors";
...
export default function Index({ monitors, filter, canAny, can }: PageProps) {
                    ...
                    {data.length > 0 ? (
                        <CardTableContent>
                            <Table>
                                ...
                                <TableBody>
                                    {data.map((monitor: MonitorProps, rowIndex: number) => (
