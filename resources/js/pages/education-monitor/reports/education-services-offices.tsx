...
import type { CanPermissions, EducationServicesOffice, Paginated } from "@/types";
...
import { index, print } from "@/routes/education-monitor/reports/education-services-offices";
...
export default function Index({ offices, filter, canAny, can }: PageProps) {
    const { data, links, ...meta } = offices;
                ...
                <section>
                    <Card>
                        <CardHeader className="border-b">
                            <CardTitle>
                                <ListIcon />
                                <span>تقرير مكاتب الخدمات التعليمية</span>
                            </CardTitle>
                        </CardHeader>
                        {data.length > 0 ? (
                            <CardTableContent>
                                <Table>
                                    ...
                                    <TableBody>
                                        {data.map((office: EducationServicesOffice, index: number) => (
