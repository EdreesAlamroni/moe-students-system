...
import type { CanPermissions, EducationServicesOffice, Enum, Paginated, School } from "@/types";
...
import { create, index, show } from "@/routes/education-monitor/schools";
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                <Select
                                    name="filter[education_services_office_id]"
                                    defaultValue={filter.education_services_office_id || undefined}
                                >
                                    <SelectTrigger>
