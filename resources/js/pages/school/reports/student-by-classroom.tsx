...
import { index, print } from "@/routes/school/reports/students-by-classroom";
...
export default function Index({
    ...
    return (
        <>
            <Head title="تقرير الطلاب حسب الفصول الدراسية" />
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                                    ...
                                    <Select
                                        name="filter[classroom_name]"
                                        defaultValue={filter.classroom_name || undefined}
                                    >
                                        <SelectTrigger>
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <TableHead scope="col">الصف الدراسي / الفصل الدراسي</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                                    ...
                                                    {student.grade_level ? (
                                                        <>
                                                            <div>
                                                                ...
                                                                {student.classroom && (
                                                                    <span className="ms-0.5">/<span className="ms-1 font-mono">{student.classroom.name}</span></span>
                                                                )}
                                                            </div>
...
Index.layout = () => ({
    breadcrumbs: [
        {
            title: 'تقرير الطلاب حسب الفصول الدراسية',
            href: index.url(),
        },
    ],
});
