...
import type { EducationMonitorSchoolDistributionItem } from "@/types";
...
type SchoolStudentsChartProps = {
    items?: EducationMonitorSchoolDistributionItem[];
    className?: string;
};
...
export default function SchoolStudentsChart({ items, className }: SchoolStudentsChartProps) {
    return (
        <DashboardSectionCard
            ...
            description="أكبر المدارس في نطاق المُراقبة من حيث عدد الطلبة المسجلين"
            icon={UsersIcon}
