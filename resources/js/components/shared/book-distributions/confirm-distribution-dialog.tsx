...
const CONTEXT_CONFIG = {
    school: {
        ...
        intro: 'أنت على وشك تسجيل استلام الكُتب للطلبة المحددين. يُسمح بتسليم الكُتب لكل طالب مرة واحدة فقط خلال السنة الدراسية الحالية.',
        countLabel: 'عدد الطلبة المحددين',
