...
#[Signature('setup:install-subjects')]
#[Description('Install subject records by grade level')]
class InstallSubjectsCommand extends Command
{
    public function handle(): int
    {
        if (Subject::query()->exists()) {
            $this->components->info('Subjects already installed. Skipping.');
        ...
        $this->components->info('Subjects installed successfully.');
    ...
    private function attributes(array $subject): array
    {
        return [
            'name' => $subject['name'],
