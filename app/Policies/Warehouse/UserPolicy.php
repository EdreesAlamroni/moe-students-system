...
class UserPolicy
{
    ...
    {
        if (! $this->hasWarehouseContext($user)) {
            return false;
        }
    ...
    private function hasWarehouseContext(User $user): bool
    {
        if ($user->organization_type !== Warehouse::class || $user->organization_id === null) {
            return false;
        }
