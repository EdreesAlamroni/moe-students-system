...
class StudentUnenrolledFromClassroomController extends Controller
{
    public function index(Request $request)
    {
        ...
        $students = QueryBuilder::for(Student::class)
            ...
            ->allowedFilters(
                ...
                AllowedFilter::exact('grade_level_id', 'student_enrollments.grade_level_id'),
                'national_id',
        ...
        return Inertia::render('school/students/unenrolled-from-classroom/index', [
